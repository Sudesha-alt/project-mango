...
## Pre-Match Prediction System (NEW)
- **Data**: GPT-5.4 web searches real H2H record (last 5 years), venue averages, recent form, squad ratings
...
- **Frontend**: Confidence bar on match cards ("MI 79% — 21% DC"), full factor breakdown on PreMatch page with direction bars
...
- `POST /api/matches/{id}/beta-predict` — Beta prediction
...
## Test Results
- iteration_8.json: 100% (16/16 backend + all frontend)
- 3 predictions cached: MI vs DC, RR vs GT, LSG vs SRH
